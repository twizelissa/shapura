...
import { addInstitution } from '@/data/mockData';
...
const AddInstitution = () => {
  ...
  const [institution, setInstitution] = useState<Omit<Institution, 'id'>>({
    name: '',
    type: 'university',
    location: '',
    website: '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${newInstitution.name} has been successfully added.`,
      });
  ...
  return (
    <Layout>
      <div className="container mx-auto py-8 px-4">
        ...
        <h1 className="text-3xl font-bold mb-6">Add New Institution</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => setInstitution(prev => ({...prev, type: value as any}))}
                      >
                        <SelectTrigger>
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Save Institution</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-gray-600 text-sm">
                    Make sure you've filled out all required fields and added at least one program.
                  </p>
